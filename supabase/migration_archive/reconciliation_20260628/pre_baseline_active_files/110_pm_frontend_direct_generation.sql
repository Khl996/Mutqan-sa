-- =============================================================================
-- Migration: 110_pm_frontend_direct_generation
-- Purpose:
--   Allow the frontend to call pm_generate_due_work_orders() directly through
--   Supabase RPC while preserving tenant isolation and role checks.
--
-- Notes:
