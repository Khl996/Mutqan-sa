            ...
            <main className="pt-32 pb-20">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto rounded-lg border border-[var(--mutqan-border)] bg-[var(--mutqan-surface)] p-6 shadow-[var(--mutqan-shadow-soft)] md:p-10">
                        <h1 className="text-3xl md:text-4xl font-black text-[var(--mutqan-text)] mb-8 pb-4 border-b border-[var(--mutqan-border)]">شروط الاستخدام</h1>

                        <div className="space-y-8 text-[var(--mutqan-muted)] leading-relaxed text-base md:text-lg">
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">مقدمة</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">1. أهلية الاستخدام والتسجيل</h2>
                            ...
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">2. طبيعة الخدمة والترخيص</h2>
                                <ul className="list-disc list-inside mt-2 space-y-2 mr-4">
                            ...
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">3. الاشتراكات والمدفوعات</h2>
                                <ul className="list-disc list-inside mt-2 space-y-2 mr-4">
                            ...
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">4. حدود المسؤولية (إخلاء المسؤولية)</h2>
                                <ul className="list-disc list-inside mt-2 space-y-2 mr-4">
                            ...
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">5. حقوق الملكية الفكرية</h2>
                                <p>
                            ...
                            <section>
                                <h2 className="text-xl font-bold text-[var(--mutqan-primary)] mb-3">6. القانون الواجب التطبيق وتسوية النزاعات</h2>
                                <p>
                            ...
                            <div className="pt-8 mt-8 border-t border-[var(--mutqan-border)]">
                                <p className="text-sm text-slate-500">
                                    لأي استفسارات قانونية، يرجى التواصل معنا عبر: <a href="mailto:info@mutqan-sa.com" className="text-[var(--mutqan-accent)] hover:underline font-mono dir-ltr">info@mutqan-sa.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
