...
export const en = {
    ...
    schedulesEmptyTitle: 'No PM schedules yet',
    schedulesEmptyHint: 'Create a schedule after choosing a job plan and linking assets.',
...
Object.assign(ar, {
    ...
    schedulesEmptyTitle: 'لا توجد جداول PM بعد',
    schedulesEmptyHint: 'أنشئ جدول PM بعد اختيار قالب العمل وربط الأصول.',
